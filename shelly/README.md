...
| Channel (old) | Channel (new) | Reason |
| ------------- | ------------- | ------ |
| `meterN#reactiveWatts` | `meterN#reactivePower` | Reactive power is measured in VAR, not Watts. Channel renamed for accuracy. Update item definitions and rules that reference this channel. |
